    ...
    window.JSJ_Gallery_SlideShow_Utilities = function() {
        ...
        self.update_pagination_string = function($numbering_el, slide_number) {
            ...
            if (slide_number !== undefined && slide_number > 0) {
                string = "(" + (slide_number + 1) + " " + __self.of_string + " " + __self.total + ")";
            } else {
        ...
        self.setInitialHeight = function($el) {
            var el = $el.get(0), height = el.children[0].height, loader_image;
            console.log("height");
            console.log(height);
            if (height > 1) {
...
(function($) {
    ...
    window.createJSJGallerySlideshow = function() {
        var settings = window.jsjGallerySlideshowOptions.settings, self = {};
        ...
        self.init = function() {
            ...
            if (window.jsjGallerySlideshowOptions.scripts_enqueued) {
                self.$galleries.cycle("destroy").cycle(settings);
            }
            return self;
        };
