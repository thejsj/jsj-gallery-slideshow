    ...
    window.JSJ_Gallery_SlideShow_Utilities = function(settings) {
        ...
        self.updatePaginationString = function($numbering_el, new_slide_number) {
            ...
            if (new_slide_number !== undefined && new_slide_number > 0) {
                string = "(" + (new_slide_number + 1) + " " + __self.of_string + " " + __self.total + ")";
            } else {
                string = "(" + 1 + " " + __self.of_string + " " + __self.total + ")";
            }
        ...
        self.setInitialHeight = function($el) {
            var el = $el.get(0), images = $el.find("img"), height = el.children[0].height, loader_image;
            if (height > 1) {
                $el.clearQueue().animate({
                    height: height
                }, 200);
...
(function($) {
    ...
    window.createJSJGallerySlideshow = function() {
        ...
        var settings = window.jsjGallerySlideshowOptions.settings, slideshow_initialized = false, self = {}, __self = {};
        __self.init = function() {
            ...
            $(window).resize(self.init).on("orientationchange", self.init);
            $(document).ready(__self.setDocumentReady);
